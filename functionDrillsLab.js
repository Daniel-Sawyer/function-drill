...
//CODE HERE
const printName = (firstName) => firstName 
...
const compareNums = (num1, num2) => {
  if(num1 > num2){
    let newnum1 = num1
    console.log(`this first is greater`);
    return newnum1
  }else if (num1 < num2){
...
let nameCheck = () => {
  ...
  console.log(`Cool name, ${nam}`);
}
}
nameGreeting = console.log(nameCheck(`Daniel`));
...
//CODE HERE
let faveColorFinder = (favcolor) => {
  color = favcolor.toLowerCase()
  if(color === `red`){
...
//CODE HERE
let sampleUpper = (sampleString) => {
  let newString = sampleString.toUpperCase()
  console.log(newString);
}
sampleUpper(sampleString)
////////////////// PROBLEM 18 ////////////////////
/*
...
console.log(emailCheck(`primosaw@gmail.com    `));
